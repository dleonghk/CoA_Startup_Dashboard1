      ...
      <div className="flex justify-center">
        <div className="grid grid-cols-2 gap-4 container p-12 bg-slate-800 rounded-lg shadow-xl max-w-4xl">
          <div>
            ...
            <p className="mb-2">
              Whether you have a question about our website, need assistance, or
              just want to give us feedback, here's how to reach us:
            </p>
            <div>
              ...
              <ul className="list-none mt-2">
                <li>
                  <strong>Email:</strong> dummy@askteamforouremail.com
                </li>
                <li>
                  <strong>Phone:</strong> (xxx) xxx-xxxx
                </li>
                <li>
                  <strong>Address:</strong> Need an address?, ATL, GA
                </li>
              </ul>
            </div>
          </div>
          <div>
            <form className="flex flex-col" onSubmit={handleSubmit}>
              ...
              <input
                ...
                id="name"
                value={formData.name}
                className="mb-4 p-2 rounded text-gray-700"
              ...
              <textarea
                ...
                className="mb-6 p-2 rounded text-gray-700"
              ...
              <button
                type="submit"
                className="p-2 bg-cyan-500 rounded hover:bg-cyan-400 transition duration-300"
              >
                Send Message
              </button>
            </form>
